...
type StartTimeDisplayProps = {
    raceIdx: number,
    classIdx: number,
    currentTime: number
}

export const StartTimeDisplay: React.FC<StartTimeDisplayProps> = (props: StartTimeDisplayProps) => {
    ...
    return (
        <>
            ...
            {msTillStart < 0 ? "Elapsed time:" : "Time to start:"}
            {days > 0 && (
                <div>
